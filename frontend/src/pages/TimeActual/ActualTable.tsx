...
interface ActualTableProps {
    ...
    onSelectAll: () => void;
    onNavigateToActual: (actualId: string) => void;
}

export const ActualTable: React.FC<ActualTableProps> = ({
    groupedActuals,
    monthRange,
    monthTotals,
    variableMonthTotals,
    ...
    const sortedGroupedActuals = getSortedGroupedActuals(groupedActuals);
    ...
    return (
        <div className="flex-1 overflow-x-auto overflow-y-auto w-full">
            <table className="w-full border-collapse text-sm">
                ...
                <tbody>
                    {sortedGroupedActuals.map(([key, group]) => {
                        const monthStatus = getActualsByMonth(group.items);
                        return (
