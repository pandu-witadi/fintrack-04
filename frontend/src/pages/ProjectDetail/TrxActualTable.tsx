    ...
    return (
        <div className="rounded-lg border bg-card p-6 shadow-sm">
            <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-semibold flex items-center gap-2">Trx <ArrowRightToLine className="h-4 w-4" /> Actual</h2>
                                ...
                                <TableCell className="text-sm min-w-fit">
                                    {trx.lActual && trx.lActual.length > 0 ? (
                                        <div className="space-y-1">
                                            {trx.lActual.map((actual: { _id: string; name: string; amount: number; typ?: string; done?: boolean }) => (
